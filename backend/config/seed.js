...
const seed = async () => {
  ...
  try {
    ...
    // ─── SEMAINES ─────────────────────────────────────────
    await client.query("INSERT INTO weeks (id, label, start_date, end_date, max_orders, is_closed, sort_order) VALUES ('w0', '1 – 7 Juin 2026', '2026-06-01', '2026-06-07', 12, true, 0), ('w1', '8 – 14 Juin 2026', '2026-06-08', '2026-06-14', 12, false, 1), ('w2', '15 – 21 Juin 2026', '2026-06-15', '2026-06-21', 12, false, 2), ('w3', '22 – 28 Juin 2026', '2026-06-22', '2026-06-28', 12, false, 3), ('w4', '29 Juin – 5 Juillet 2026', '2026-06-29', '2026-07-05', 12, false, 4), ('w5', '6 – 12 Juillet 2026', '2026-07-06', '2026-07-12', 12, false, 5), ('w6', '13 – 19 Juillet 2026', '2026-07-13', '2026-07-19', 12, false, 6) ON CONFLICT (id) DO NOTHING;");
